...
class Item {
    ...
    static get style() { return "\n.sc-ion-item-ios-h {\n  --min-height: 44px;\n  --background: var(--ion-color-base);\n  --background-active: var(--ion-color-tint);\n  --color: var(--ion-color-contrast);\n  --detail-push-color: var(--ion-color-shade);\n  --border-radius: 0;\n  --border-width: 0;\n  --border-style: solid;\n  --border-color: var(--ion-color-shade);\n  --inner-border-width: 0;\n  --padding-top: 0;\n  --padding-bottom: 0;\n  --padding-end: 0;\n  --padding-start: 0;\n  --inner-padding-top: 0;\n  --inner-padding-bottom: 0;\n  --inner-padding-start: 0;\n  --inner-padding-end: 0;\n  --box-shadow: none;\n  --inner-box-shadow: none;\n  --highlight-color-focus: var(--ion-color-primary, #3880ff);\n  --highlight-color-valid: var(--ion-color-success, #10dc60);\n  --highlight-color-invalid: var(--ion-color-danger, #f04141);\n  --highlight-height: 2px;\n  -moz-osx-font-smoothing: grayscale;\n  -webkit-font-smoothing: antialiased;\n  display: block;\n  color: var(--ion-color-contrast);\n  text-align: initial;\n  text-decoration: none;\n  -webkit-box-sizing: border-box;\n  box-sizing: border-box; }\n\n.activated.sc-ion-item-ios-h {\n  --background: var(--background-active); }\n\n.item-disabled.sc-ion-item-ios-h {\n  cursor: default;\n  opacity: .3;\n  pointer-events: none; }\n\n.item-native.sc-ion-item-ios {\n  padding: var(--padding-top) var(--padding-end) var(--padding-bottom) var(--padding-start);\n  border-radius: var(--border-radius);\n  margin: 0;\n  font-family: inherit;\n  font-size: inherit;\n  font-weight: inherit;\n  letter-spacing: inherit;\n  text-decoration: inherit;\n  text-overflow: inherit;\n  text-transform: inherit;\n  text-align: inherit;\n  white-space: inherit;\n  color: inherit;\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  position: relative;\n  -webkit-box-align: center;\n  -ms-flex-align: center;\n  align-items: center;\n  -webkit-box-pack: justify;\n  -ms-flex-pack: justify;\n  justify-content: space-between;\n  width: 100%;\n  min-height: var(--min-height);\n  -webkit-transition: var(--transition);\n  transition: var(--transition);\n  border-width: var(--border-width);\n  border-style: var(--border-style);\n  border-color: var(--border-color);\n  outline: none;\n  background-color: var(--background);\n  -webkit-box-shadow: var(--box-shadow);\n  box-shadow: var(--box-shadow);\n  overflow: hidden;\n  -webkit-box-sizing: border-box;\n  box-sizing: border-box; }\n\nbutton.sc-ion-item-ios, a.sc-ion-item-ios {\n  cursor: pointer;\n  -webkit-user-select: none;\n     -moz-user-select: none;\n      -ms-user-select: none;\n          user-select: none;\n  -webkit-user-drag: none; }\n\n.item-state.sc-ion-item-ios {\n  left: 0;\n  right: 0;\n  bottom: 0;\n  position: absolute;\n  height: var(--highlight-height); }\n\n.item-inner.sc-ion-item-ios {\n  margin: 0;\n  padding: var(--inner-padding-top) var(--inner-padding-end) var(--inner-padding-bottom) var(--inner-padding-start);\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-flex: 1;\n  -ms-flex: 1;\n  flex: 1;\n  -webkit-box-orient: inherit;\n  -webkit-box-direction: inherit;\n  -ms-flex-direction: inherit;\n  flex-direction: inherit;\n  -webkit-box-align: inherit;\n  -ms-flex-align: inherit;\n  align-items: inherit;\n  -ms-flex-item-align: stretch;\n  align-self: stretch;\n  min-height: inherit;\n  border-width: var(--inner-border-width);\n  border-style: var(--border-style);\n  border-color: var(--border-color);\n  -webkit-box-shadow: var(--inner-box-shadow);\n  box-shadow: var(--inner-box-shadow);\n  overflow: hidden;\n  -webkit-box-sizing: border-box;\n  box-sizing: border-box; }\n\n.input-wrapper.sc-ion-item-ios {\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-flex: 1;\n  -ms-flex: 1;\n  flex: 1;\n  -webkit-box-orient: inherit;\n  -webkit-box-direction: inherit;\n  -ms-flex-direction: inherit;\n  flex-direction: inherit;\n  -webkit-box-align: inherit;\n  -ms-flex-align: inherit;\n  align-items: inherit;\n  -ms-flex-item-align: stretch;\n  align-self: stretch;\n  text-overflow: ellipsis;\n  overflow: hidden;\n  -webkit-box-sizing: border-box;\n  box-sizing: border-box; }\n\n[vertical-align-top].sc-ion-item-ios-h, .item-input.sc-ion-item-ios-h {\n  -webkit-box-align: start;\n  -ms-flex-align: start;\n  align-items: flex-start; }\n\n.sc-ion-item-ios-s > ion-icon {\n  font-size: 1.6em; }\n\n.sc-ion-item-ios-s > ion-button {\n  --margin-top: 0;\n  --margin-bottom: 0;\n  --margin-start: 0;\n  --margin-end: 0;\n  z-index: 1; }\n\n.item-label-stacked.sc-ion-item-ios-h   .input-wrapper.sc-ion-item-ios, .item-label-floating.sc-ion-item-ios-h   .input-wrapper.sc-ion-item-ios {\n  -webkit-box-flex: 1;\n  -ms-flex: 1;\n  flex: 1;\n  -webkit-box-orient: vertical;\n  -webkit-box-direction: normal;\n  -ms-flex-direction: column;\n  flex-direction: column; }\n\n.sc-ion-item-ios-h.item-label-stacked.sc-ion-item-ios-s > ion-select, .sc-ion-item-ios-h.item-label-floating.sc-ion-item-ios-s > ion-select {\n  -ms-flex-item-align: stretch;\n  align-self: stretch;\n  max-width: 100%; }\n\n.item-textarea.sc-ion-item-ios-h {\n  -webkit-box-align: stretch;\n  -ms-flex-align: stretch;\n  align-items: stretch; }\n\n.sc-ion-item-ios-h.item-multiple-inputs .sc-ion-item-ios-s > ion-select {\n  position: relative; }\n\n.sc-ion-item-ios-h.item-label-stacked .sc-ion-item-ios-s > ion-select, .sc-ion-item-ios-h.item-label-floating .sc-ion-item-ios-s > ion-select {\n  max-width: 100%; }\n\n.sc-ion-item-ios-s > ion-reorder[slot] {\n  margin-top: 0;\n  margin-bottom: 0; }\n\n.sc-ion-item-ios-h {\n  --ion-color-base: var(--ion-item-background, transparent);\n  --ion-color-contrast: var(--ion-item-text-color, var(--ion-text-color, #000));\n  --ion-color-tint: var(--ion-item-background-color-active, #d9d9d9);\n  --ion-color-shade: var(--ion-item-border-color, #c8c7cc);\n  --transition: background-color 200ms linear;\n  --padding-start: 16px;\n  --inner-padding-end: 8px;\n  --inner-border-width: 0 0 0.55px 0;\n  font-family: var(--ion-font-family, inherit);\n  font-size: 17px; }\n\n.activated.sc-ion-item-ios-h {\n  --transition: none; }\n\n\@media screen and (orientation: landscape) {\n  .item-inner.sc-ion-item-ios {\n    padding-left: calc(constant(safe-area-inset-left) + var(--inner-padding-start));\n    padding-right: calc(constant(safe-area-inset-right) + var(--inner-padding-end));\n    padding-left: calc(env(safe-area-inset-left) + var(--inner-padding-start));\n    padding-right: calc(env(safe-area-inset-right) + var(--inner-padding-end)); } }\n\n.item-lines-full.sc-ion-item-ios-h {\n  --border-width: 0 0 0.55px 0; }\n\n.item-lines-inset.sc-ion-item-ios-h {\n  --inner-border-width: 0 0 0.55px 0; }\n\n.item-lines-inset.sc-ion-item-ios-h, .item-lines-none.sc-ion-item-ios-h {\n  --border-width: 0; }\n\n.item-lines-full.sc-ion-item-ios-h, .item-lines-none.sc-ion-item-ios-h {\n  --inner-border-width: 0; }\n\n.sc-ion-item-ios-s > :not(.interactive)[slot=\"start\"] {\n  margin: 2px 16px 2px 0; }\n\n.sc-ion-item-ios-s > :not(.interactive)[slot=\"end\"] {\n  margin-left: 8px;\n  margin-right: 8px; }\n\n.sc-ion-item-ios-s > ion-icon[slot=\"start\"], .sc-ion-item-ios-s > ion-icon[slot=\"end\"] {\n  margin-left: 0;\n  margin-top: 7px;\n  margin-bottom: 7px; }\n\n.sc-ion-item-ios-h.item-label-stacked .sc-ion-item-ios-s > [slot=\"end\"], .sc-ion-item-ios-h.item-label-floating .sc-ion-item-ios-s > [slot=\"end\"] {\n  margin-top: 7px;\n  margin-bottom: 7px; }\n\n.sc-ion-item-ios-s > .button-small {\n  --padding-top: 0;\n  --padding-bottom: 0;\n  --padding-start: .5em;\n  --padding-end: .5em;\n  --height: 24px;\n  font-size: 13px; }\n\n.sc-ion-item-ios-s > ion-avatar {\n  width: 36px;\n  height: 36px; }\n\n.sc-ion-item-ios-s > ion-thumbnail {\n  width: 56px;\n  height: 56px; }\n\n.sc-ion-item-ios-s > ion-avatar[slot=\"end\"], .sc-ion-item-ios-s > ion-thumbnail[slot=\"end\"] {\n  margin: 8px; }\n\n.item-detail-icon.sc-ion-item-ios {\n  color: var(--detail-push-color);\n  font-size: 20px; }\n\n.sc-ion-item-ios-h.item-radio .sc-ion-item-ios-s > ion-label, .sc-ion-item-ios-h.item-toggle .sc-ion-item-ios-s > ion-label {\n  margin-left: 0; }\n\n.sc-ion-item-ios-h.item-label-stacked .sc-ion-item-ios-s > ion-input, .sc-ion-item-ios-h.item-label-floating .sc-ion-item-ios-s > ion-input, .sc-ion-item-ios-h.item-label-stacked .sc-ion-item-ios-s > ion-textarea, .sc-ion-item-ios-h.item-label-floating .sc-ion-item-ios-s > ion-textarea {\n  --padding-top: 8px;\n  --padding-bottom: 8px;\n  --padding-start: 0; }\n"; }
...
class Nav {
    ...
    static get style() { return "\n.sc-ion-nav-h {\n  left: 0;\n  right: 0;\n  top: 0;\n  bottom: 0;\n  position: absolute;\n  contain: layout size style;\n  overflow: hidden;\n  z-index: 0; }\n\n.nav-decor.sc-ion-nav {\n  display: none; }\n\n.show-decor.sc-ion-nav-h   .nav-decor.sc-ion-nav {\n  left: 0;\n  right: 0;\n  top: 0;\n  bottom: 0;\n  display: block;\n  position: absolute;\n  background: #000;\n  z-index: 0;\n  pointer-events: none; }\n"; }
}
